...
<canvas class="webgl" bind:this={canvas} data-testing="scene-canvas"></canvas>
...
<!-- mobile joystick -->
<div class="mobile-joystick" bind:this={joystickElement} data-testing="interaction-state">
