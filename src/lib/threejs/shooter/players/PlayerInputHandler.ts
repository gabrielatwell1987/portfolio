...
export class PlayerInputHandler {
	private targetSquareResolver: ((value: Vector3 | null) => void) | null = null;
	private targetObjectResolver: ((value: GameObject | null) => void) | null = null;
	...
	async getTargetSquare(): Promise<Vector3 | null> {
		return new Promise((resolve) => {
			...
			this.dom.addEventListener('touchstart', handleTouchStart, { passive: false });
