...
<section class="skills-container">
	<div class="skills-inner" aria-label="skills">
		...
		<ul class="skills">
				...
				<li>
					<div class="icons">
						<Image
							...
							alt="html"
							aspectRatio="1/1"
							style="width: clamp(50px, 6vw, 200px);"
						/>

						<span class="hover-text" aria-hidden="true">structure</span>
					</div>
				</li>
			</a>
			...
			<a class="skill" href="https://developer.mozilla.org/en-US/docs/Learn/CSS" target="_blank">
				<li>
					<div class="icons">
						...
						<span class="hover-text" aria-hidden="true">styles</span>
					</div>
				</li>
			</a>
			...
			>
				<li>
					<div class="icons">
						...
						<span class="hover-text" aria-hidden="true">interaction</span>
					</div>
				</li>
			</a>

			<a class="skill" href="https://svelte.dev/" target="_blank" aria-label="Svelte">
				<li>
					<div class="icons">
						<svg class="skill-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"
							><path
			...
			<a class="skill" href="https://gsap.com" target="_blank" aria-label="GSAP">
				<li>
					<div class="icons">
						<svg
							class="skill-icon"
						...
						<span class="hover-text" aria-hidden="true">animations</span>
					</div>
				</li>
			</a>

			<a class="skill" href="https://nodejs.org" target="_blank" aria-label="Node.js">
				<li>
					<div class="icons">
						<svg
							class="skill-icon"
							...
							fill="none"
							viewBox="0 0 256 256"
							><rect width="256" height="256" fill="none" rx="60" /><path
								fill="var(--clr-green)"
						...
						<span class="hover-text" aria-hidden="true">backend</span>
					</div>
				</li>
			</a>

			<a class="skill" href="https://github.com" target="_blank" aria-label="GitHub">
				<li>
					<div class="icons">
						<svg
							class="skill-icon"
						...
						<span class="hover-text" aria-hidden="true">version control</span>
					</div>
				</li>
			</a>

			<a class="skill" href="https://markdownguide.org" target="_blank" aria-label="Markdown">
				<li>
					<div class="icons">
						<svg
							class="skill-icon"
						...
						<span class="hover-text" aria-hidden="true">documentation</span>
					</div>
				</li>
			</a>

			<a class="skill" href="https://tailwindcss.com" target="_blank" aria-label="Tailwind CSS">
				<li>
					<div class="icons">
						<svg
							class="skill-icon"
							...
							/><defs
								><linearGradient
									...
									><stop stop-color="var(--clr-blue)" /><stop
										offset="1"
										stop-color="var(--clr-blue)"
									/></linearGradient
								></defs
							></svg
						>

						<span class="hover-text" aria-hidden="true">styling</span>
					</div>
				</li>
			</a>
		</ul>
			...
			.skill {
				...
				& .icons {
					& .hover-text {
						...
						font-size: clamp(var(--xxs), 0.75vw, var(--sm));
						z-index: 10;
						margin-inline: auto;
						opacity: 0;
						transition: all 1s;
